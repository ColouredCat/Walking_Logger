# Simple algorithm to convert lat long to os grid referances and vice versa
# Taken from https://scipython.com/blog/converting-between-an-os-grid-reference-and-longitudelatitude/
